...
class EtaQuatro(models.Model):
    ...
    filtro5 = models.DecimalField('Filtro 5', max_digits=4, decimal_places=2, blank=True, null=True)
    filtro6 = models.DecimalField('Filtro 6', max_digits=4, decimal_places=2, blank=True, null=True)
    filtro7 = models.DecimalField('Filtro 7', max_digits=4, decimal_places=2, blank=True, null=True)
